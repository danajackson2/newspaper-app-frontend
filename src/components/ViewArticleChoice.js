        ...
        <div className={'container'} style={{padding: '10px'}}>
            <div className='row'>
                ...
                <div className={'col-10'} style={{borderColor: 'black', borderStyle:'solid', borderWidth:'1px', borderRadius:'3px', height:'260px',padding: '5px', backgroundColor:'#eee2d6'}}>
                    <h4>{articles[currentView].title === '' ? 'No title' : articles[currentView].title}</h4>
                    <h4>{articles[currentView].author === '' ? 'No author' : articles[currentView].author}</h4>
                    <p>{articles[currentView].description === '' ? 'No article summary' : articles[currentView].description}</p>
